...
#  (23) -> 'Number of: many'
def num_of_items(count: int) -> str:
...
# Пример 'welcome' -> 'weme'.
def start_end_symbols(s: str) -> str:
...
# Пример: 'bibble' -> 'bi**le'
def replace_char(my_str: str) -> str:
    return my_str[0] + my_str[1:].replace(my_str[0], '*')
